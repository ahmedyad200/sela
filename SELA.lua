...
if res ~= 200 then
print('\27[0;31m┉ ┉  𝒑𝒐𝒘𝒆𝒓┉ ┉ ┉ ┉  𝒑𝒐𝒘𝒆𝒓┉ ┉ ┉ ┉\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na┉ ┉  𝒑𝒐𝒘𝒆𝒓┉ ┉ ┉ ┉  𝒑𝒐𝒘𝒆𝒓┉ ┉ ┉ ┉\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m┉ ┉  𝒑𝒐𝒘𝒆𝒓┉ ┉ ┉ ┉  𝒑𝒐𝒘𝒆𝒓┉ ┉ ┉ ┉ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua SELA.lua')
end
...
io.write('\27[1;31m ↓ ارسل معرف4 المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "┉ ┉  𝒑𝒐𝒘𝒆𝒓┉ ┉ ┉ ┉  𝒑𝒐𝒘𝒆𝒓┉ ┉ ┉ ┉  𝒑𝒐𝒘𝒆𝒓┉ ┉ ┉ ┉ ┉┉ ┉  𝒑𝒐𝒘𝒆𝒓┉ ┉ ┉ ┉"
echo "TG IS NOT FIND IN FILES BOT"
echo "┉ ┉  𝒑𝒐𝒘𝒆𝒓┉ ┉ ┉ ┉  𝒑𝒐𝒘𝒆𝒓┉ ┉ ┉ ┉  𝒑𝒐𝒘𝒆𝒓┉ ┉ ┉ ┉  𝒑𝒐𝒘𝒆𝒓┉ ┉ ┉ ┉ ┉ ┉ ┉"
exit 1
fi
if [ ! $token ]; then
echo "┉ ┉  𝒑𝒐𝒘𝒆𝒓┉ ┉ ┉ ┉  𝒑𝒐𝒘𝒆𝒓┉ ┉ ┉ ┉  𝒑𝒐𝒘𝒆𝒓┉ ┉ ┉ ┉  𝒑𝒐𝒘𝒆𝒓┉ ┉ ┉ ┉  𝒑𝒐𝒘𝒆𝒓┉ ┉ ┉"
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./SELA.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("GT", "w")  
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SELATEAM/Files_SELA/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1444059892,1059262308,944353237}   
...
if tonumber(user_id) == tonumber(1444059892) then  
var = true  
elseif tonumber(user_id) == tonumber(1059262308) then
var = true  
...
SELA_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
SELA_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
SELA_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
SELA_Msg = 'امبروطور التفاعل' 
...
--------------------------------------------------------------------------------------------------------------
function sopowerr(msg,data) -- بداية العمل
if msg then
...
{'تغير رساله الاشتراك','مسحرساله الاشتراك ☆↯','تغير الاشتراك'},
...
send(msg.chat_id_, msg.id_,SELA_Msg) 
return false  
end 
if text then    
...
if text == 'مسح كليشه ستارت ☆↯' and SudoBot(msg) then 
...
os.execute('wget https://raw.githubusercontent.com/ahmedyad200/SELA/main/SELA.lua')
send(msg.chat_id_, msg.id_,' ☆↯⇠ تم تحديث السورس \n ☆↯⇠ لديك اخر اصدار لسورس سيلا\n ☆↯⇠ الاصدار » { 1.3v}')
dofile('SELA.lua')  
end
if text == 'الاصدار ☆↯' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ☆↯⇠ اصدار سورس سيلا\n ☆↯⇠ الاصدار »{ 1.3v}')
end
...
if text == 'كلب نسخه الاحتياطيه ☆↯' and SudoBot(msg) then 
GetFile_Bot(msg)
end
...
if text == "مسح الجروبات ☆↯" and SudoBot(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'☆↯⇠  عدد الجروبات الان » { '..#group..' }'..SELAk..''..SELA..'\n☆↯⇠  الان عدد الجروبات الحقيقي » { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ☆↯⇠ العضو » ['..result.title_..'](t.me/'..(username or 'sopowerr')..')'
status  = '\n ☆↯⇠ تم ترقيته مطور'
...
usertext = '\n ☆↯⇠ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sopowerr')..')'
status  = '\n ☆↯⇠ تم ترقيته مطور'
...
local SELA1_Msg = database:get(bot_id.."SELA1:Add:Filter:Rp2"..text..msg.chat_id_)   
if SELA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☆↯⇠ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'sopowerr')..') \n ☆↯⇠ '..SELA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if SELA_Msg and not Special(msg) then  
local SELA_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if SELA_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ☆↯⇠ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ☆↯⇠ ["..SELA_Msg.."] \n")
else
send(msg.chat_id_,0," ☆↯⇠ العضو : {["..data.first_name_.."](T.ME/sopowerr)}\n ☆↯⇠ ["..SELA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ☆↯⇠ عذرا » {["..data.first_name_.."](T.ME/sopowerr)}\n ☆↯⇠ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
os.execute('rm -rf SELA.lua')
os.execute('wget https://raw.githubusercontent.com/zoro283/SELA/main/SELA.lua')
send(msg.chat_id_, msg.id_,' ☆↯⇠ تم تحديث السورس \n ☆↯⇠ لديك اخر اصدار لسورس سيلا\n ☆↯⇠ الاصدار » { 1.3v}')
dofile('SELA.lua')  
end
...
if text == "مسحرساله الاشتراك ☆↯" and SudoBot(msg) then  
...
Text = [[
↯♡  ━━━  ᵴᵉᴌẤ  ━━━ ♡
 [- The Source Developer ](https://t.me/a_l_e_x_1_5) ☆ .
  [- The Source Developer ](https://t.me/ahmedyad200) ☆ .
 [- The SOURCE channel](https://t.me/sopowerr) ☆ .
♡  ━━━  ᵴᵉᴌẤ  ━━━ ♡
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
if text == 'مسحالاوامر المضافه' or text == 'مسح الاوامر المضافه' then
...
if text == 'مسحامر' or text == 'مسح امر' then 
if Constructor(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ☆↯⇠ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'sopowerr')..') \n ☆↯⇠ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☆↯⇠ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'sopowerr')..') \n ☆↯⇠ تـم قفـل التاك بالكتم ')
end,nil)   
...
if result.sender_user_id_ == tonumber(944353237) then
send(msg.chat_id_, msg.id_, " ☆↯⇠ لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.sender_user_id_ == tonumber(1444059892) then
send(msg.chat_id_, msg.id_, " ☆↯⇠ لا يمكنك حظر ملك التليجرام 👑 \n")
return false 
end
if result.sender_user_id_ == tonumber(1059262308) then
send(msg.chat_id_, msg.id_, " ☆↯⇠ لا يمكنك حظر ملك التليجرام 👑 \n")
return false 
end
...
if result.sender_user_id_ == tonumber(1444059892) then
send(msg.chat_id_, msg.id_, " ☆↯⇠ لا يمكنك كتم ملك التليجرام 👑\n")
return false 
end
if result.sender_user_id_ == tonumber(944353237) then
...
if text == ("تاك للمنشئين الاساسين") or text == ("نادي المنشئين الاساسين") then
local list = database:smembers(bot_id..'Basic:Constructor'..msg.chat_id_)
t = "\n ☆↯⇠ نتو فينن تعالو يريدوكم بجروب \n≪↯━━━━━━𝒑𝒐𝒘𝒆𝒓━━━━━━━↯≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- {[@"..username.."]}\n"
...
if text == ("تاك للمنشئين") or text == ("نادي المنشئين") then
local list = database:smembers(bot_id..'Constructor'..msg.chat_id_)
t = "\n ☆↯⇠ نتو فينن تعالو يريدوكم بجروب \n≪↯━━━━━━𝒑𝒐𝒘𝒆𝒓━━━━━━━↯≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
if text == ("تاك للمدراء") or text == ("نادي المدراء") then
local list = database:smembers(bot_id..'Manager'..msg.chat_id_)
t = "\n ☆↯⇠ نتو فينن تعالو يريدوكم بجروب \n≪↯━━━━━━𝒑𝒐𝒘𝒆𝒓━━━━━━━↯≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
if text == ("تاك للادمنيه") or text == ("نادي الادمنيه") then
local list = database:smembers(bot_id..'Mod:User'..msg.chat_id_)
t = "\n ☆↯⇠ نتو فينن تعالو يريدوكم بجروب \n≪↯━━━━━━𝒑𝒐𝒘𝒆𝒓━━━━━━━↯≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
if text == ("تاك للمنظفين") or text == ("نادي المنظفين") then
local list = database:smembers(bot_id..'VVVZVV:MN:TF'..msg.chat_id_)
t = "\n ☆↯∫ نتو فينن تعالو يريدوكم بجروب \n≪━━━━━━𝘽𝙆━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
if text == ("تاك للمميزين") or text == ("نادي المميزين") then
local list = database:smembers(bot_id..'Special:User'..msg.chat_id_)
t = "\n ☆↯⇠ نتو فينن تعالو يريدوكم بجروب \n≪↯━━━━━━𝒑𝒐𝒘𝒆𝒓━━━━━━━↯≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ☆↯⇠ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sopowerr')..')'
status  = '\n ☆↯⇠ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ☆↯⇠ العضو » '..userid..''
...
------------------------------------------------------------------------
if text == 'تنزيل المتزوجات' and Mod(msg) then
database:del(bot_id..'Mote:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ☆↯⇠ تم مسح جميع المتزوجات')
end
if text == ("تاك للزوجات") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n ☆↯⇠ قائمة المتجوزين الجروب \n≪↯━━━━━━𝒑𝒐𝒘𝒆𝒓━━━━━━━↯≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» زوجه [@"..username.."]\n"
...
---------
if text == ("رفع زوجه") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل زوجه")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-----------------------------------------------------
if text == 'تنزيل التونزات' and Mod(msg) then
database:del(bot_id..'Mode:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ☆↯⇠ تم مسح جميع التونزات')
end
if text == ("تاك للتونزات") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n ☆↯⇠ قائمه تونزات الجروب \n≪↯━━━━━━𝒑𝒐𝒘𝒆𝒓━━━━━━━↯≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» التونز [@"..username.."]\n"
else
t = t..""..k.."» التونز `"..v.."`\n"
end
end
if #list == 0 then
t = " ☆↯⇠ مع الاسف لا يوجد تونز"
end
send(msg.chat_id_, msg.id_, t)
end
---------
if text == ("رفع تونز") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local  statuss  = '\n ☆↯⇠ تم رفع العضــو التونز في الجروب \n ☆↯⇠ تعال يتونز ممكن نتعرف'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل التونز")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☆↯⇠ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sopowerr')..')'
status  = '\n ☆↯⇠ تم تنزيل العضــو التونز من الجروب\n ☆↯⇠ مشيي مو خوش تونزه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
-----------------------------------------------------
if text == 'تنزيل التونز' and Mod(msg) then
...
---------
if text == ("رفع التونز") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_, ' ☆↯⇠ تم تنزيل جميع الحصونه من الجروب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☆↯⇠ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sopowerr')..')'
local  statuss  = '\n ☆↯⇠ تم رفع المتهم حصان بالجروب\n ☆↯⇠ الان اصبح حصان الجروب'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ☆↯⇠ تم تنزيل جميع الحمير بالجروب')
end
...
-----------------------------------------------------
if text == 'تنزيل الاغبياء' and Mod(msg) then
database:del(bot_id..'Tele:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ☆↯⇠ تم تنزيل جميع الاغبياء بالجروب')
end
if text == ("تاك للاغبياء") and Mod(msg) then
local list = database:smembers(bot_id..'Tele:User'..msg.chat_id_)
t = "\n ☆↯⇠ قائمة الاغبياء الجروب \n≪↯━━━━━━𝒑𝒐𝒘𝒆𝒓━━━━━━━↯≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☆↯⇠ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sopowerr')..')'
local  statuss  = '\n ☆↯⇠ تم رفع الغبي في الجروب\n ☆↯⇠ طلع برا ابو الغباا الوصخ'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ☆↯⇠ تم تنزيل جميع الخولات')
end
...
send(msg.chat_id_, msg.id_, ' ☆↯⇠ تم تنزيل جميع الوتكات')
end
if text == ("تاك للوتكات") and Mod(msg) then
local list = database:smembers(bot_id..'Jred:User'..msg.chat_id_)
t = "\n ☆↯⇠ قائمة الالوتكات الجروب \n≪↯━━━━━━𝒑𝒐𝒘𝒆𝒓━━━━━━━↯≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
------------------------------------------------------------------------
if text and text:match("^فك التقييد (%d+)$") and Mod(msg) then
local userid = text:match("^فك التقييد (%d+)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☆↯⇠  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sopowerr')..')'
status  = '\n ☆↯⇠  الايدي » `'..result.sender_user_id_..'`\n ☆↯⇠  تم تنزيله ادمن من الجروب بكل صلاحياته'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
send(msg.chat_id_,msg.id_," ☆↯⇠ ليست لدي صلاحية التثبيت يرجى التحقق من صلاحياته")  
end
end,nil) 
end
...
if text == 'مسح الرابط' or text == 'مسحالرابط' then
if Mod(msg) then     
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == "مسحالصوره" or text == "مسح الصوره" then 
if Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == 'مسح الترحيب' or text == 'مسحالترحيب' then 
if Mod(msg) then
...
database:set(bot_id.."SELA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."SELA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ☆↯⇠ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."SELA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."SELA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."SELA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."SELA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ☆↯⇠ تم منع الكلمه مع التحذير")  
database:del(bot_id.."SELA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."SELA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."SELA1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."SELA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ☆↯⇠ ارسل الكلمه الان")  
database:set(bot_id.."SELA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."SELA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."SELA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SELA1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."SELA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."SELA1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."SELA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SELA1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."SELA1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ☆↯⇠ قائمة المنع \n≪↯━━━━━━𝒑𝒐𝒘𝒆𝒓━━━━━━━↯≫\n"
for k,v in pairs(list) do  
local SELA_Msg = database:get(bot_id.."SELA1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..SELA_Msg.."}\n"    
end  
if #list == 0 then  
t = " ☆↯⇠ لا يوجد كلمات ممينعه"  
end  
send(msg.chat_id_, msg.id_,t)  
end  
...
if text == 'مسحالايدي' or text == 'مسح الايدي' then
if Manager(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == 'مسح القوانين' or text == 'مسحالقوانين' then  
if Mod(msg) then
...
if text == 'صلاحياته' and Mod(msg) then 
local list = database:smembers(bot_id..'Coomds'..msg.chat_id_)
if #list == 0 then
send(msg.chat_id_, msg.id_,' ☆↯⇠ لا توجد صلاحيات مضافه')
return false
end
t = "\n ☆↯⇠ قائمة صلاحياته المضافه \n≪↯━━━━━━𝒑𝒐𝒘𝒆𝒓━━━━━━━↯≫\n"
for k,v in pairs(list) do
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ☆↯⇠ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'sopowerr')..')'..'\n ☆↯⇠ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == "مسح رسايلي" or text == "مسح رسائلي" or text == "مسحرسايلي" or text == "مسحرسائلي" then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'باور').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'باور')
local SELA_Msg = {
'بحبك 🥺💕.',
'هاا شتريد كافي ☹️.',
'انا بوت وربنا.','
}
send(msg.chat_id_, msg.id_,'['..SELA_Msg[math.random(#SELA_Msg)]..']') 
return false
end
...
if text == 'مسح رد عام' and SudoBot(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سيلا').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'sopowerr')..')'
local iduser = result.sender_user_id_
...
if text and text:match("^نادي (.*)$") then
local username = text:match("^نادي (.*)$") 
if not database:get(bot_id..'Seh:User'..msg.chat_id_) then
function start_function(extra, result, success)
...
send(msg.chat_id_, msg.id_,' ☆↯⇠ لا استطيع انادي معرف قنوات') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,' ☆↯⇠ لا استطيع انادي معرف بوتات') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,'⚠| لا اسطيع نادي معرفات الجروبات') 
return false  
end
if result.id_ then
send(msg.chat_id_, msg.id_,' ☆↯⇠ تعال حبي يناديونك بل جروب [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
else
send(msg.chat_id_, msg.id_,' ☆↯⇠ تم تعطيل امر نادي') 
end
return false
end
...
if text == 'تفعيل نادي' and Manager(msg) then   
if database:get(bot_id..'Seh:User'..msg.chat_id_) then
Text = ' ☆↯⇠ تم تفعيل امر نادي'
database:del(bot_id..'Seh:User'..msg.chat_id_)  
else
Text = ' ☆↯⇠ بالتاكيد تم تفعيل امر نادي'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if text == 'تعطيل نادي' and Manager(msg) then  
if not database:get(bot_id..'Seh:User'..msg.chat_id_) then
database:set(bot_id..'Seh:User'..msg.chat_id_,true)  
Text = '\n ☆↯⇠ تم تعطيل امر نادي'
else
Text = '\n ☆↯⇠ بالتاكيد تم تعطيل امر نادي'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if text == "مسح سحكاتي" or text == "مسحسحكاتي" then  
send(msg.chat_id_, msg.id_,' ☆↯⇠ تم مسح سحكاتك'  )  
database:del(bot_id..'edits'..msg.chat_id_..msg.sender_user_id_)
end
if text == "مسح جهاتي" or text == "مسحجهاتي" then  
...
-- vardump(data) 
SELAdx(msg.chat_id_, msg.id_, ' ☆↯⇠ ايدي المجموعة » ( '..msg.chat_id_..' )\n ☆↯⇠ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ☆↯⇠ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ☆↯⇠ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'الصلاحيات' and Manager(msg) then
...
☆↯⇠ الاوامر … كالتالي
 •↯━━━━━━𝒑𝒐𝒘𝒆𝒓━━━━━━━↯•ٴ
☆↯⇠استعاده الاوامر
☆↯⇠نادي ~ تاك ~ المميزين : الادمنيه : المدراء : المنشئين : المنشئين الاساسين
☆↯⇠كشف القيود
☆↯⇠تعين الايدي
☆↯⇠ الحساب + ايدي الحساب
☆↯⇠مسح + العدد
...
name = string.gsub(name,'اني','زوجه')
...
name = string.gsub(name,'ضراطه','الي يسوق زوجه يتحمل___')
name = string.gsub(name,'بيدك','اكل___محد يفيدك')
name = string.gsub(name,'الحافي','تجدي من___نعال')
name = string.gsub(name,'شقره','مع الخيل يا___')
name = string.gsub(name,'النخله','الطول طول___والعقل عقل الحصانة')
...
send(msg.chat_id_, msg.id_, t..'ٴ☆↯⇠ٴ≪━━━━━━𝒑𝒐𝒘𝒆𝒓━━━━━━≫ٴ☆↯⇠○ٴ\n☆↯⇠ 彡 .[C𝐇𝐀𝐍𝐍𝐄𝑳](t.me/sopowerr)➢ ')
end
...
local texting = {"ادب سسز يباوع علي بنات 😂🥺"," مو خوش ولد 😶","خول وما احبه 😾😹"}
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"مووووووووواححح????","مابوس ولي😌😹","خدك/ج نضيف 😂","البوسه بالف حمبي 🌝💋","خلي يزحفلي وابوسه 🙊😻","كل شويه ابوسه كافي 😏","ماابوسه والله هذا خول🦎","محح هاي لتونز صاكه??"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
t =[[
رابط المسحفي جميع مواقع التواصل ☆↯
فكر قبل لا تتسرع وتروح
ٴ≪━━━━power━━━━━≫ٴ
 ☆↯ رابط مسح [Telegram](https://my.telegram.org/auth?to=delete) ܁
 ☆↯ رابط مسح [instagram](https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/) ܁
 ☆↯ رابط مسح [Facebook](https://www.facebook.com/help/deleteaccount) ܁
 ☆↯ رابط مسح [Snspchat](https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount) ܁
]]
send(msg.chat_id_, msg.id_,t) 
return false
end
...
send(msg.chat_id_, msg.id_,' ☆↯⇠ تم مسحالامر')  
else
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سيلا')
if not database:get(bot_id.."Fun_Bots:"..msg.chat_id_) then
if text ==  ""..Name_Bot..' شنو رئيك بهاذا' and tonumber(msg.reply_to_message_id_) > 0 then     
function FunBot(extra, result, success) 
local Fun = {'لوكي وخول من ساع زحفلي وحضرته 😒','خوش ولد و ورده مال الله 💋🙄','يلعب ع البنات 🙄', 'ولد زايعته الكاع 😶🙊','صاك يخبل ومعضل ','محلو وشواربه جنها مكناسه 😂🤷🏼‍♀️','اموت عليه 🌝','هوه غير الحب مال اني 🤓❤️','مو خوش ولد صراحه ☹️','ادبسز وميحترم البنات  ', 'فد واحد قذر 🙄😒','ماطيقه كل ما اكمشه ريحته جنها بخاخ بف باف مال حشرات 😂🤷‍♀️','مو خوش ولد 🤓' } 
...
function FunBot(extra, result, success) 
local Fun = {'الكبد مال اني ','يولي ماحبه ',' لٱ ايع ','بس لو الكفها اله اعضها 💔','ماخب المتجوزين اسف','اكلك ۿذﭑ يكلي احبكك لولا ﭑݩٺ شتكول  ','ئووووووووف اموت ع ربه ','ايععععععععع','بلعباس اعشكك','ماحب مخابيل','احبب ميدو وبس','لٱ ماحبه','بله هاي جهره تكلي تحبهه ؟ ','بربك ئنته والله فارغ وبطران وماعدك شي تسوي جاي تسئلني احبهم لولا','افبس حبيبي هذا' } 
send(msg.chat_id_,result.id_,''..Fun[math.random(#Fun)]..'') 
end  
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunBot, nil)
return false
...
SELA = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(SELA)
...
------------------------------------------------------------------------
local SELAAbot = database:get(bot_id.."SELA1:Add:Filter:Rp2"..text..result.chat_id_)   
if SELAAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ☆↯⇠ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ☆↯⇠ ["..SELAAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local SELA1_Msg = database:get(bot_id.."SELA1:Add:Filter:Rp2"..text..result.chat_id_)   
if SELA1_Msg then    
send(msg.chat_id_, msg.id_," ☆↯⇠ "..SELA1_Msg)
